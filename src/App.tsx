...
function App() {
  ...
  return (
    <div>
      {pokemonFinded.name !== "" ? <div><img src="https://t2.tudocdn.net/568114?w=646&h=284" /><span style={{ fontSize: 24, fontWeight: 'bold',  transform: 'rotate(-90deg)', position: 'absolute', right: 20, top: '45%' }}>{pokemonFinded.name}</span></div> : null }
